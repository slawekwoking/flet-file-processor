...
class FileProcessorApp:
    ...
    def build_ui(self):
        ...
        header = ft.Container(
            content=ft.Column([
                ...
                ft.Text("Load and analyze text files", size=14, color=ft.Colors.GREY_600),
    ...
    def on_file_picked(self, e: ft.FilePickerResultEvent):
        ...
        if e.files:
            ...
            self.file_info.value = f"Selected: {e.files[0].name} ({e.files[0].size} bytes)"
    ...
    def process_file(self, e):
        ...
        try:
            ...
            self.stats_text.value = ""
            self.status_text.value = "Error: Cannot read file (binary or invalid encoding)"
